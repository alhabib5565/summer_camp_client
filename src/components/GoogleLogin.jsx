    ...
    const handleGoogleLogin = () => {
        ...
        googleLogin()
            .then((result) => {
                ...
                const savaUserData = { name: user.displayName, email: user.email, photo: user.photoURL, role: 'student', whenYouRegister: new Date() }
        ...
        <div>
            {
                loading ? <LoadingButton></LoadingButton> : <button
                    ...
                    className="flex w-full justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
