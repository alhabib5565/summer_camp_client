...
const InstructorCard = ({instructor}) => {
    return (
        <div className='max-w-md w-full overflow-hidden relative transition duration-200 transform hover:-translate-y-2 rounded shadow-lg hover:shadow-2xl'>
            <img
                src={instructor.instructorPhoto || instructor.photo}
                alt='book cover'
